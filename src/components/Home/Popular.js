      ...
      <div className="px-4 mx-20 md:mx-0">
        <div className="flex items-end mb-14 flex-wrap relative ">
          <div className="basis-1/2 pb-7 header_popular relative  md:basis-full md:text-center after:md:mx-auto ">
            <span className="mb-3 text-[#bcbcbc] font-semibold text-xs">
              ONLINE STREAMING
            </span>
          ...
          <div className="basis-1/2 flex items-end md:flex-wrap md:basis-full justify-center ">
            <div className="flex  w-full  md:justify-center md:mb-4">
              <p
                className={`btn mr-3 mt-3 ml-auto md:ml-0 ${
                  tab && "bg-yellow-color text-black "
                } border-yellow-color`}
                onClick={() => {
                  setTab(true);
                }}
            ...
            <div className="flex   py-2 px-5  h-14 ">
              <p
                ...
                className="hover:text-yellow-color cursor-pointer pre font-black relative pr-4  leading-9"
              >
                {" "}
              ...
              <p
                ...
                className="leading-9 hover:text-yellow-color cursor-pointer"
              >
                {" "}
                <FontAwesomeIcon
                  className="ml-5 font-black"
                  icon={faAngleRight}
                />
              </p>
            </div>
        ...
        <div>
          <Swiper
            className="flex mySwiper swiper "
            breakpoints={{
              300: {
                slidesPerView: 1,
              },
