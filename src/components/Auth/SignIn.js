        ...
        <div className='w-[500px] mx-auto mt-20 text-center'>
          ...
          <div>
            <form onSubmit={onSubmitForm}>
                ...
                <div className='my-8' >
                  <button type="submit" className='btn border-yellow-color' >SIGN IN</button>
                </div>
            </form>
          </div>
          <div className='flex justify-center text-lg'>
              <p>Not a member? </p>
              <p className='hover:cursor-pointer ml-3 text-yellow-color underline-offset-2 underline' onClick={()=>{props.setShow(false)}}>Sign Up</p>
          </div>
